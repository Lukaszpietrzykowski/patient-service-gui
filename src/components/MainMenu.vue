        ...
        <section class="fixed-bottom d-flex flex-row justify-content-center align-items-center w-100 p-1 bg-transparent">
            ...
            <div class="bg-for-menu bg-main justify-content-center align-items-center d-flex flex-row menu-fixed-bottom-inner px-4 w-max-content">
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <h2 class="font-small color-white font-weight-normal text-center " style="font-size: 0.75rem;">Dodaj szpital</h2>
                </div>
                ...
                <div class="d-flex flex-column justify-content-center">
                   ...
                   <router-link to="/patients"  class="bg-transparent mt-2"> 
                    ...
                    <h2 class="font-small color-white font-weight-normal text-center " style="font-size: 0.75rem;">Dodaj pacjenta</h2>
                </div>
            </div>
