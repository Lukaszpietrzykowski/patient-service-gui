<template>
    ...
    <section class="bg-white position-relative d-flex flex-column align-items-center justify-content-center h-100">
        ...
        <div class="my-5" v-if="hospitals.length">
            <div  v-for="hospital_one of filteredHospitals" v-bind:key="hospital_one.name" class="d-flex p-3 my-3 w-100 justify-content-center flex-column flex-md-row menu-hospital-box">
