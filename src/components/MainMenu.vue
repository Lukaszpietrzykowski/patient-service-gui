        ...
        computed: {
            filteredList() {
                return this.hospitals.filter(hospital => {
                    ...
                    return (hospital.address.streetNumber + hospital.name + hospital.address.street + hospital
                        .address.city + hospital.address.postalCode + deps).toLowerCase().includes(this
                        .search.toLowerCase())
                })
            }
