<template>
    ...
    <section class="bg-white position-relative d-flex flex-column align-items-center justify-content-center h-100">
                ...
                <div class="w-100 py-1 p-lg-3">
                    <div class="w-100 d-flex flex-column flex-lg-row p-2 justify-content-center align-items-center">
                        ...
                        <div class="d-flex flex-column p-1">
                            <div v-if="this.userRole === 'ADMIN'" v-on:click="updatePatient(patient.id)" class="d-flex flex-column justify-content-center action-button">
                              ...
                              <h2 class="font-small color:#626466 font-weight-normal text-center" style="font-size: 0.75rem; letter-spacing: 0.5px">Edytuj pacjenta</h2>
                            </div>
        ...
        <section
            ...
            <div
                class="bg-for-menu bg-main justify-content-center align-items-center gap-0 gap-md-2 gap-lg-3 d-flex flex-row menu-fixed-bottom-inner px-4 w-max-content">
              <MenuComponent/>
            </div>
        </section>
    </section>
