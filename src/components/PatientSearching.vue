<template>
    ...
    <section class="bg-white position-relative d-flex flex-column align-items-center justify-content-center h-100">
        ...
        <header class="d-flex flex-column justify-content-center w-100 bg-for-menu bg-main menu-header p-3">
            <form class="d-flex justify-content-center w-100">
                ...
                <div class="w-75 w-lg-50 d-flex flex-row justify-content-center">
                    ...
                    <input class="input-search h-100 p-0 m-0 outline-none border-0 " type="text" id="searchpatient" name="searchpatient" placeholder="Wyszukaj pacjenta" onfocus="this.placeholder=''" onblur="this.placeholder='Wyszukaj pacjenta'">
                </div> 
        ...
        <div class="d-flex p-4 mt-3 w-100 w-lg-75 justify-content-center flex-row flex-md-row menu-hospital-box">
