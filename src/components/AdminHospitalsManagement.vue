        ...
        <div class="my-5 w-100" >
            <div v-for="hospital in hospitals" v-bind:key="hospital.id"
                class="d-flex align-items-center p-3 my-3 w-100 w-lg-75 mx-auto justify-content-center flex-column flex-md-row menu-hospital-box">
                    ...
                    <div class="w-100 py-1 p-lg-3">
                        ...
                        <div class="w-100 d-flex flex-row mt-1 p-2 justify-content-center"  >
                            <div v-for="department in hospital.departments" v-bind:key="department.id" class="">{{department.name}}</div>
                ...
                <div class="d-flex flex-column p-1">
                    ...
                    <div v-on:click="managementWards(hospital.id)" class="d-flex flex-column justify-content-center action-button">
                        <span class="bg-transparent mt-2">
