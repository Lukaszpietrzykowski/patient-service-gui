            ...
            <form class=" d-flex-row flex-md-row" v-on:submit.prevent="submit">
              ...
              <div class="d-flex flex-row">
                <div style="width: 70%">
                  ...
                  <div><input class="input-user" type="text" name="odzdział" v-model="newDepartment.name" required placeholder="Kardiologia"></div>
                </div>
                <div style="width: 30%">
                  <div class="color-grey mt-2 font-small">Ilość łóżek</div>
                  <div><input class="input-departments" type="text" name="miasto" v-model="newDepartment.availableBeds" required pattern="[0-9]+" placeholder="0"></div>
                </div>
              </div>
        ...
        <div class="justify-content-center w-80">
          ...
          <div id="department-list-box" v-for="department in departments" v-bind:key="department.id" class="d-flex p-1 justify-content-center menu-hospital-box">
              ...
              <div class="d-flex flex-row">
                <div class="w-100 d-flex flex-row p-2 justify-content-center align-items-center" style="gap:0.75rem">
                  <div id="departments-view">
                    <div>
                      <svg width="20" fill="#05a081" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                ...
                <div class="w-100 d-flex flex-row p-2 justify-content-center align-items-center" style="gap:0.75rem">
                  <div id="all-beds-view">
                    <div>
                      <svg width="25" fill="#05a081" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    ...
                    <div style="font-weight: bold; max-width: 100%;">
                      <input class="input-departments" type="number" style="width: 30%" min="0" v-model="department.availableBeds" v-on:keyup="checkValue(department)" v-on:change="checkValue(department)">
                    </div>
                  </div>
                </div>
                <div class="w-100 d-flex flex-row p-2 justify-content-center align-items-center" style="gap:0.75rem">
                ...
                <div id="departments-edit-buttons">
                  <div v-on:click="disableEditMode" class="d-flex flex-row justify-content-center action-button" style="gap:0.75rem">
                    <a class="bg-transparent mt-3">
                      <svg class="menu-departments-form-button" fill="#05a081" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM99.5 144.8C77.15 176.1 64 214.5 64 256C64 362 149.1 448 256 448C297.5 448 335.9 434.9 367.2 412.5L99.5 144.8zM448 256C448 149.1 362 64 256 64C214.5 64 176.1 77.15 144.8 99.5L412.5 367.2C434.9 335.9 448 297.5 448 256V256z"/></svg>
                    </a>
                  ...
                  <div v-on:click.prevent="this.edit.isDataCorrect && submitEdit(department)" class="d-flex flex-row justify-content-center action-button" style="gap:0.75rem">
                    ...
                    <h2 class="font-small color-wblack font-weight-normal text-center mt-3" style="font-size: 0.75rem; letter-spacing: 0.5px">Zatwierdz zmiany</h2>
                  </div>
                </div>
              </div>
            ...
            <div v-else class="d-flex flex-row justify-content-center align-items-center w-100">
              ...
              <div id="departments-edit-buttons">
                <div v-on:click="toggleEditMode(department.id)" class="d-flex flex-row justify-content-center action-button" style="gap:0.75rem">
                  <a class="bg-transparent mt-3">
                    <svg class="menu-departments-form-button" fill="#05a081" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M464 16c-17.67 0-32 14.31-32 32v74.09C392.1 66.52 327.4 32 256 32C161.5 32 78.59 92.34 49.58 182.2c-5.438 16.81 3.797 34.88 20.61 40.28c16.89 5.5 34.88-3.812 40.3-20.59C130.9 138.5 189.4 96 256 96c50.5 0 96.26 24.55 124.4 64H336c-17.67 0-32 14.31-32 32s14.33 32 32 32h128c17.67 0 32-14.31 32-32V48C496 30.31 481.7 16 464 16zM441.8 289.6c-16.92-5.438-34.88 3.812-40.3 20.59C381.1 373.5 322.6 416 256 416c-50.5 0-96.25-24.55-124.4-64H176c17.67 0 32-14.31 32-32s-14.33-32-32-32h-128c-17.67 0-32 14.31-32 32v144c0 17.69 14.33 32 32 32s32-14.31 32-32v-74.09C119.9 445.5 184.6 480 255.1 480c94.45 0 177.4-60.34 206.4-150.2C467.9 313 458.6 294.1 441.8 289.6z"/></svg>
                  </a>
                  <h2 class="font-small color-wblack font-weight-normal text-center mt-3" style="font-size: 0.75rem; letter-spacing: 0.5px">Edytuj oddział</h2>
                </div>
                <div v-on:click="removeDepartment(department.id)" class="d-flex flex-row justify-content-center action-button" style="gap:0.75rem">
                  <a class="bg-transparent mt-3">
                    <svg class="menu-departments-form-button" fill="#05a081" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z"/></svg>
                  </a>
                  <h2 class="font-small color-wblack font-weight-normal text-center mt-3" style="font-size: 0.75rem; letter-spacing: 0.5px">Usuń oddział</h2>
                </div>
              </div>
            </div>
          </div>
