...
<section class="d-flex flex-column flex-lg-row vh-100">
    ...
    <section class="w-100">
        <div class="d-flex p-4 mt-2 w-100 mx-auto justify-content-center algn-items-center flex-column  menu-hospital-box">
            <h1>Lista oddziałów</h1>
        </div>
        <div class="d-flex p-4 mt-2 w-100 mx-auto justify-content-center flex-column  menu-hospital-box">
        ...
        <div class="d-flex p-2 mt-2 w-75 mx-auto justify-content-center flex-column  menu-hospital-box">
            <form class="pt-2 pb-2 p-2 d-flex-row">
                    ...
                    <div><input class="input-user" type="text" name="odzdział" placeholder="Kardiologia"></div>
                    </div>
                    <div class="color-grey mt-2 font-small" >ilość łóżek</div>
                    <div><input class="input-user" type="text" name="miasto" placeholder="0"></div>
