<template>
  <div v-if="$route.path !== '/patients'" class="d-flex flex-column justify-content-center">
    ...
    <h2 class="font-small color-white font-weight-normal text-center "
        style="font-size: 0.75rem; letter-spacing: 0.5px">Pacjenci</h2>
  </div>

  <div v-if="($route.path !== '/hospitals')" class="d-flex flex-column justify-content-center">
    <router-link to="/hospitals" class="bg-transparent mt-2">
    ...
    <h2 class="font-small color-white font-weight-normal text-center "
        style="font-size: 0.75rem;">Szpitale</h2>
  </div>

  <div v-if="($route.path !== '/users-management' && this.userRole === 'ADMIN')" class="d-flex flex-column justify-content-center">
    <router-link to="/users-management" class="bg-transparent mt-2">
      <svg class="menu-fixed-button" xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 640 512">
        <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        <path
    ...
    <h2 class="font-small color-white font-weight-normal text-center "
        style="font-size: 0.75rem;">Zarządzanie użytkownikami</h2>
  </div>
  <div v-if="($route.path !== '/hospitals-management' && this.userRole === 'ADMIN')" class="d-flex flex-column justify-content-center">
    <router-link to="/hospitals-management" class="bg-transparent mt-2">
      <svg class="menu-fixed-button" xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 640 512">
        <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        <path
    ...
    <h2 class="font-small color-white font-weight-normal text-center "
        style="font-size: 0.75rem;">Zarządzanie szpitalami</h2>
  </div>
  ...
  <div class="d-flex flex-column justify-content-center">
    ...
    <h2 class="font-small color-white font-weight-normal text-center "
        style="font-size: 0.75rem; letter-spacing: 0.5px">Dodaj pacjenta</h2>
  </div>
</template>
